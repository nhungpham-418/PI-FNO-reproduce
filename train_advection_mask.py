...
from train_utils.datasets import AdvectionLoaderMask
from train_utils.train_2d import train_2d_advection_mask
...
def run(args, config):
    ...
    dataset = AdvectionLoaderMask(data_config['datapath'],
